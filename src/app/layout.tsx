...
export const metadata: Metadata = {
  title: "Luxuria Hotel - 5-Star Luxury Accommodations Downtown",
  description: "Experience unparalleled luxury at Luxuria Hotel. Premium suites, Michelin-star dining, world-class spa, and personalized service in the heart of the city.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, fine dining, spa resort, business travel, downtown hotel",
  metadataBase: new URL("https://luxuriahotel.com"),
  alternates: {
    canonical: "https://luxuriahotel.com"
  },
  openGraph: {
    title: "Luxuria Hotel - 5-Star Luxury Experience",
    description: "Indulge in sophisticated elegance with our premium accommodations, award-winning service, and exclusive amenities.",
    url: "https://luxuriahotel.com",
    ...
    images: [
      {
        ...
        alt: "Luxuria Hotel elegant exterior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    description: "Premium 5-star accommodations with exceptional service and world-class amenities in downtown.",
